...
var MESSAGES = {
	'fr': {
		...
		'message.item.load.error': 'Erreur lors du chargement',
		'message.item.delete.error': 'Erreur lors de la suppression',
		...
		'message.settings.saved': 'Réglages sauvegardés',
		'message.settings.save.error': 'Erreur lors de la sauvegarde',
		'label.stash.default': 'Ma réserve',
		'label.settings.currentStash': 'Réserve active',
	...
	'en': {
		...
		'message.item.load.error': 'Error loading item',
		'message.item.delete.error': 'Error deleting item',
		...
		'message.settings.save.error': 'Error saving item',
		'label.stash.default': 'My stash',
		'label.settings.currentStash': 'Active stash',
